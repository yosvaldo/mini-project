...
export default function CheckoutPage() {
  ...
  return (
    <>
      <Helmet>
        <title>{`Checkout - ${event.title} | Eventura`}</title>
        <meta name="description" content="Complete registration forms, claim points deductions, and attach valid verification proofs." />
      </Helmet>
